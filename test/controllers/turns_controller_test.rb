...
class TurnsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create turn" do
    assert_difference("Turn.count") do
      post turns_url, params: { turn: { company_id: @turn.company_id, date: @turn.date, engineer_id: @turn.engineer_id } }
    end
  ...
  test "should update turn" do
    patch turn_url(@turn), params: { turn: { company_id: @turn.company_id, date: @turn.date, engineer_id: @turn.engineer_id } }
